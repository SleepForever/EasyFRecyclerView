...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof BaseAdapter) {
            headerCount = ((BaseAdapter) parent.getAdapter()).getHeaderLayoutCount();
            footerCount = ((BaseAdapter) parent.getAdapter()).getFooterLayoutCount();
        }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof BaseAdapter) {
            headerCount = ((BaseAdapter) parent.getAdapter()).getHeaderLayoutCount();
            footerCount = ((BaseAdapter) parent.getAdapter()).getFooterLayoutCount();
            dataCount = ((BaseAdapter) parent.getAdapter()).getData().size();
        } else {

...
package com.example.frecyclerviewlibrary.decoration;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mIncludeHeader) {
            if (parent.getAdapter() instanceof BaseAdapter) {
                int headerCount = ((BaseAdapter) parent.getAdapter()).getHeaderLayoutCount();
                int footerCount = ((BaseAdapter) parent.getAdapter()).getFooterLayoutCount();
                int dataCount = ((BaseAdapter) parent.getAdapter()).getData().size();
